...
public class PddOrderShippingLog implements Serializable {
    private Long id;
    ...
    @ApiModelProperty(value = "发货返回信息")
    private String response;

    @ApiModelProperty(value = "拼多多发货同步信息")
    private String pddSyncResponse;
    ...
    public String getPddSyncResponse() {
        return pddSyncResponse;
    }

    public void setPddSyncResponse(String pddSyncResponse) {
        this.pddSyncResponse = pddSyncResponse;
    }
    ...
    public String toString() {
        ...
        sb.append(", pddSyncResponse=").append(pddSyncResponse);
